...
func init() {
	...
	initCmd.Flags().StringVar(&initAppDomain, "app-domain", "", "frontend app domain (e.g., https://your-app.com)")
...
func runInit(cmd *cobra.Command, args []string) error {
	...
	config, err := initcmd.ValidateAndGetConfig(initTenantID, initBackendAppID, initBackendAppSecret, initLogtoDomain, initAppDomain)
	if err != nil {
		return err
	}
