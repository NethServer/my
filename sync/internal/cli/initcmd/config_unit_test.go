...
func TestValidateAndGetConfig(t *testing.T) {
	...
	envVars := []string{"TENANT_ID", "BACKEND_APP_ID", "BACKEND_APP_SECRET", "TENANT_DOMAIN", "APP_DOMAIN"}
	...
	t.Run("CLI mode - all flags provided", func(t *testing.T) {
		...
		assert.Equal(t, "https://cli-app.com", config.AppDomain)
	...
	t.Run("environment mode - all vars set", func(t *testing.T) {
		...
		_ = os.Setenv("APP_DOMAIN", "https://env-app.com")
		...
		assert.Equal(t, "https://env-app.com", config.AppDomain)
...
func TestInitConfig(t *testing.T) {
	t.Run("InitConfig structure", func(t *testing.T) {
		...
		assert.Equal(t, "https://test-app.com", config.AppDomain)
