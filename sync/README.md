...
# App domain configuration (required for init command)
...
sync init --tenant-id your-tenant-id --backend-app-id your-backend-app-id --backend-app-secret your-secret --logto-domain your-domain.com --app-domain https://your-app.com --owner-username owner --owner-email owner@example.com
...
- `--app-domain`: Frontend application domain (required, e.g., https://app.yourcompany.com)
...
sync init --tenant-id your-tenant-id --backend-app-id your-app-id --backend-app-secret your-secret --logto-domain your-domain.com --app-domain https://your-app.com
