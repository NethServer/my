...
import { getQueryStringParams, getQueryStringParamsForExport } from './resellers'
...
describe('resellers getQueryStringParamsForExport', () => {
  ...
  it('never sends include_hierarchy: the parent company filter is an exact match', () => {
    const params = parse(
      getQueryStringParamsForExport(
        'csv',
        undefined,
