...
func (s *InventoryService) GetLatestInventory(systemID string) (*models.InventoryRecord, error) {
	query := `
...
func (s *InventoryService) GetInventoryHistory(systemID string, page, pageSize int, fromDate, toDate *time.Time) ([]models.InventoryRecord, int, error) {
...
func (s *InventoryService) GetInventoryDiffs(systemID string, page, pageSize int, severity, category, diffType string, fromDate, toDate *time.Time) ([]models.InventoryDiff, int, error) {
...
func (s *InventoryService) GetLatestInventoryDiffs(systemID string) ([]models.InventoryDiff, error) {
	query := `
