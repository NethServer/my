...
func (s *LocalSystemsService) GetSystemsByOrganizationPaginated(userID, userOrgID, userOrgRole string, page, pageSize int, search, sortBy, sortDirection string, filters models.SystemListFilters) ([]*models.System, int, error) {
	...
	systems, totalCount, err := systemRepo.ListByCreatedByOrganizations(allowedOrgIDs, page, pageSize, search, sortBy, sortDirection, filters)
	if err != nil {
		return nil, 0, err
	}
