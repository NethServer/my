...
func TestConfigurableDiffer_IsSignificantChange(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:       "never significant nethvoice total calls",
			fieldPath:  "facts.modules.nethvoice1.nethvoice_total_calls",
			changeType: "update",
			category:   "modules",
			severity:   "low",
			from:       149751,
		...
		{
			name:       "never significant nethvoice calls last 24h",
			fieldPath:  "facts.modules.nethvoice1.nethvoice_calls_last_24h",
			changeType: "update",
			category:   "modules",
			severity:   "medium",
			from:       244,
		...
		{
			name:       "never significant nethvoice nethlink active count",
			fieldPath:  "facts.modules.nethvoice1.nethvoice_nethlink_active_count",
			changeType: "update",
			category:   "modules",
			severity:   "medium",
			from:       9,
		...
		{
			name:       "never significant nethvoice devices by model subkey",
			fieldPath:  "facts.modules.nethvoice58.nethvoice_physical_devices_by_model.fanvil-V62",
			changeType: "create",
			category:   "modules",
			severity:   "high",
			from:       nil,
		...
		{
			name:       "never significant traefik acme certificates counter",
			fieldPath:  "facts.modules.traefik1.acme_auto_certificates",
			changeType: "delete",
			category:   "modules",
			severity:   "high",
			from:       6,
		...
		{
			name:       "never significant traefik name module map",
			fieldPath:  "facts.modules.traefik1.name_module_map",
			changeType: "delete",
			category:   "modules",
			severity:   "high",
			from:       "{}",
