...
def main():
    ...
    list_parser.add_argument("--state", help="Filter by state (e.g. active, suppressed, unprocessed)")
    list_parser.add_argument("--severity", help="Filter by severity label")
    list_parser.add_argument("--system-key", dest="system_key", help="Filter by system_key label")
