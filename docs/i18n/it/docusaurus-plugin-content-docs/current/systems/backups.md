...
- `system_id` è l'identificatore interno stabile assegnato alla creazione.
...
| `x-amz-meta-uploader-ua` | `User-Agent` dell'appliance; traccia la versione software in uso.        |
